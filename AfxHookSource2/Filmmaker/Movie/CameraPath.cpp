...
// --- hover picking: CameraPath::UpdateHover lives in CameraPathPicking.cpp (the
// viewport-dependent crosshair pick; everything else in this file is viewport-free) ---
